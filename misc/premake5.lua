--[[
To customize the following settings table, create a file named "premake5-local.lua" in this directory.
...
-- Include the local configuration file if it exists
local localFilename = "premake5-local.lua"

if os.isfile(localFilename) then
	dofile(localFilename)
end
