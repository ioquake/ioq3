...
cp ${TMPDIR}/SDL2-${SDL_VERSION}/lib/x86/SDL3.dll ${CODE}/libs/win32/
cp ${TMPDIR}/SDL2-${SDL_VERSION}/lib/x86/SDL3.lib ${CODE}/libs/win32/
cp ${TMPDIR}/SDL2-${SDL_VERSION}/i686-w64-mingw32/lib/libSDL3.dll.a ${CODE}/libs/win32/

cp ${TMPDIR}/SDL2-${SDL_VERSION}/lib/x64/SDL3.dll ${CODE}/libs/win64/
cp ${TMPDIR}/SDL2-${SDL_VERSION}/lib/x64/SDL3.lib ${CODE}/libs/win64/
cp ${TMPDIR}/SDL2-${SDL_VERSION}/x86_64-w64-mingw32/lib/libSDL3.dll.a ${CODE}/libs/win64/
