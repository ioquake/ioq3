...
the name I have used throughout the source code and I will continue using in
this readme. Since the code on how to handle those MDR files was released
under a GPL license a long time ago, I was able to implement this format for
...
You can check out the original eliteforce game source code if you want to
