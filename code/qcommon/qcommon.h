...
typedef intptr_t(QDECL *vmMainProc)(int callNum, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6,
...
void *QDECL Sys_LoadGameDll(const char *name, vmMainProc *entryPoint, int32_t(QDECL *systemcalls)(intptr_t, ...));
