...
#ifdef STANDALONE
  #define PRODUCT_NAME				"FWioq3"
  #define BASEGAME					"baseFW"
  #define CLIENT_WINDOW_TITLE		"FWioquake3"
  #define CLIENT_WINDOW_MIN_TITLE	"FWioq3"
  #define HOMEPATH_NAME_UNIX		".FWioq"
  #define HOMEPATH_NAME_WIN			"FWioq3"
  #define HOMEPATH_NAME_MACOSX		HOMEPATH_NAME_WIN
//  #define STEAMPATH_NAME			"Foo Bar"
//  #define STEAMPATH_APPID         ""
  #define GAMENAME_FOR_MASTER		"fwioq3"	// must NOT contain whitespace
