...
// Changes Globals:		-
//===========================================================================
int Sys_MilliSeconds(void) { return clock() * 1000 / CLOCKS_PER_SEC; } // end of the function Sys_MilliSeconds
//===========================================================================
//
// Parameter:				-
// Returns:					-
...
int Export_BotLibSetup(void) {
	...
	if (botDeveloper) { Log_Open("botlib.log"); }
...
int BotExportTest(int parm0, char *parm1, vec3_t parm2, vec3_t parm3) {
	...
	*/
	for (i = 0; i < 2; i++)
		if (!line[i]) line[i] = botimport.DebugLineCreate();
	...
	if (newarea != area) {
		...
		if (!aasworld.areasettings[area].contents) { botimport.Print(PRT_MESSAGE, "empty"); } // end if
		botimport.Print(PRT_MESSAGE, "\n");
		botimport.Print(
	...
	*/
	...
	if (parm0 & 2)
		...
		*/
		...
		curarea = newarea;
		for (i = 0; i < 100; i++) {
			if (curarea == goal.areanum) { break; }
			reachnum = BotGetReachabilityToGoal(curorigin, curarea, lastgoalareanum, lastareanum, avoidreach,
