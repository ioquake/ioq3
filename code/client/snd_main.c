...
void S_Init( void )
{
	...
	s_volume = Cvar_Get( "s_volume", "0.8", CVAR_ARCHIVE, "Missing description." );
	s_musicVolume = Cvar_Get( "s_musicvolume", "0.25", CVAR_ARCHIVE, "Missing description." );
	s_muted = Cvar_Get("s_muted", "0", CVAR_ROM, "Missing description.");
	s_doppler = Cvar_Get( "s_doppler", "1", CVAR_ARCHIVE, "Missing description." );
	s_backend = Cvar_Get( "s_backend", "", CVAR_ROM, "Missing description." );
	s_muteWhenMinimized = Cvar_Get( "s_muteWhenMinimized", "0", CVAR_ARCHIVE, "Missing description." );
	s_muteWhenUnfocused = Cvar_Get( "s_muteWhenUnfocused", "0", CVAR_ARCHIVE, "Missing description." );

	cv = Cvar_Get( "s_initsound", "1", 0, "Missing description." );
	if( !cv->integer ) {
		...
		cv = Cvar_Get( "s_useOpenAL", "1", CVAR_ARCHIVE, "Missing description." );
		if( cv->integer ) {
			//OpenAL
