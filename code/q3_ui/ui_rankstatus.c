...
static void RankStatus_MenuEvent(void *ptr, int event) {
	...
	case ID_OK:
		...
		switch (s_status) {
		case QGR_STATUS_NO_USER: UI_RankingsMenu(); break;
		...
		case QGR_STATUS_USER_EXISTS:
			...
			UI_SignupMenu();
			break;
		case QGR_STATUS_NO_MEMBERSHIP: UI_RankingsMenu(); break;
		case QGR_STATUS_TIMEOUT: UI_RankingsMenu(); break;
		case QGR_STATUS_INVALIDUSER: UI_RankingsMenu(); break;
		case QGR_STATUS_ERROR: UI_RankingsMenu(); break;
		default: break;
		}
...
===============
*/
void RankStatus_Cache(void) { trap_R_RegisterShaderNoMip(RANKSTATUS_FRAME); }
...
void UI_RankStatusMenu(void) {
	...
	case QGR_STATUS_NO_USER:
		...
		break;
	case QGR_STATUS_BAD_PASSWORD: s_rankstatus_message = "Invalid password"; break;
	case QGR_STATUS_TIMEOUT: s_rankstatus_message = "Timed out"; break;
	case QGR_STATUS_NO_MEMBERSHIP: s_rankstatus_message = "No membership"; break;
	case QGR_STATUS_INVALIDUSER: s_rankstatus_message = "Validation failed"; break;
	case QGR_STATUS_ERROR: s_rankstatus_message = "Error"; break;
	case QGR_STATUS_SPECTATOR:
	case QGR_STATUS_ACTIVE: UI_ForceMenuOff(); return;
	default: return;
	}
	RankStatus_MenuInit();
