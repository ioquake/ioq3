...
static void UI_CinematicsMenu_Init(void) {
	...
	if (uis.demoversion) { cinematicsMenuInfo.cin_intro.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(1)) { cinematicsMenuInfo.cin_tier1.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(2)) { cinematicsMenuInfo.cin_tier2.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(3)) { cinematicsMenuInfo.cin_tier3.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(4)) { cinematicsMenuInfo.cin_tier4.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(5)) { cinematicsMenuInfo.cin_tier5.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(6)) { cinematicsMenuInfo.cin_tier6.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(7)) { cinematicsMenuInfo.cin_tier7.generic.flags |= QMF_GRAYED; }
	...
	if (!UI_CanShowTierVideo(8)) { cinematicsMenuInfo.cin_end.generic.flags |= QMF_GRAYED; }
