...
void Main_MenuEvent(void *ptr, int event) {
	...
	case ID_DEMOS: UI_DemosMenu(); break;

	case ID_CINEMATICS: UI_CinematicsMenu(); break;

	case ID_MODS: UI_ModsMenu(); break;
	...
	case ID_EXIT: UI_ConfirmMenu("EXIT GAME?", 0, MainMenu_ExitAction); break;
	}
}
...
===============
*/
void MainMenu_Cache(void) { s_main.bannerModel = trap_R_RegisterModel(MAIN_BANNER_MODEL); }
...
static void Main_MenuDraw(void) {
	...
	if (uis.demoversion) {
		UI_DrawProportionalString(320, 372, "DEMO      FOR MATURE AUDIENCES      DEMO", UI_CENTER | UI_SMALLFONT,
								  color);
		UI_DrawString(320, 400, "Quake III Arena(c) 1999-2000, Id Software, Inc.  All Rights Reserved",
					  UI_CENTER | UI_SMALLFONT, color);
	} else {
		UI_DrawString(320, 450, "Quake III Arena(c) 1999-2000, Id Software, Inc.  All Rights Reserved",
					  UI_CENTER | UI_SMALLFONT, color);
	}
}
...
static qboolean UI_TeamArenaExists(void) {
	...
	for (i = 0; i < numdirs; i++) {
		...
		if (Q_stricmp(dirptr, BASETA) == 0) { return qtrue; }
...
void UI_MainMenu(void) {
	...
	if (!uis.demoversion) { Menu_AddItem(&s_main.menu, &s_main.mods); }
